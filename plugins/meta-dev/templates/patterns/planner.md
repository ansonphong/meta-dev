...
- **Added:** 2026-03-28
- **Rule:** When a task adds a field/property to any model or type, trace propagation through every consuming layer and record acceptance at each boundary. Related propagation may share one coherent task/slice; separate workers are not required.
