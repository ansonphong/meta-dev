...
Meta-dev hooks and scripts are pure bash/jq/python — no model-specific code paths. Plans generated by meta-dev are hardened for Sonnet-class models (Claude Sonnet 4.6, Opus 4.7, and compatible backends):
